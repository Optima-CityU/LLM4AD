...
// import Auxiliary.CpuTime; // Replaced by ThreadMXBean for consistency with Origin I/O
...
public class AILSII
{
    ...
    // [Added from Origin] High precision timing
    ...
    public AILSII(Instance instance,InputParameters reader)
    {
        ...
        this.threadMXBean = ManagementFactory.getThreadMXBean(); // Init timer
    ...
    // ---------------------------------------------------------
    // [Added from Origin] Output Helper Methods START
    // ---------------------------------------------------------
    ...
    // ---------------------------------------------------------
    // Output Helper Methods END
    // ---------------------------------------------------------

    public void search()
    {
        iterator=0;
        // [Modified] Use ThreadMXBean for time consistency
        ...
        bestF = bestSolution.f; // Ensure bestF is updated initially

        // [Added from Origin] Initial Write
        ...
        while(!stoppingCriterion())
        {
            ...
            evaluateSolution(); // This now handles CSV/SOL writing inside
            distAdjustment.distAdjustment();
        ...
        // [Modified] Use ThreadMXBean and Final Write
    ...
    public void evaluateSolution()
    {
        ...
        {
            // [Modified] Added null check and I/O logic from Origin
            if (solution != null && solution.routes != null) {
                bestF = solution.f;
                bestSolution.clone(solution);
                iteratorMF = iterator;

                // [Modified] Use ThreadMXBean
                ...
                // [Added from Origin] Write updates
    ...
    {
        // [Modified] Use ThreadMXBean for Time check
        switch(stoppingCriterionType)
        {
            ...
            case Time: 	if(bestF<=optimal||executionMaximumLimit < (threadMXBean.getCurrentThreadCpuTime() - first) / 1_000_000_000)
                return true;
                break;
        }
        return false;
    ...
    {
        // [Modified] Replaced main with Origin's robust logic
        ...
        System.out.println("开始搜索(Deco): " + instanceName);
        if (customOutput != null) {

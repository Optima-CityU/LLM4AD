    ...
    def _iteratively_use_eoh_operator(self):
        while self._continue_loop():
            try:
                ...
                prompt = EoHPrompt.get_prompt_e1(self._task_description_str, indivs, self._template_program)
                if self._debug_mode:
                ...
                if self._use_e2_operator:
                    operator = 'e2'
                    indivs = [self._population.selection() for _ in range(self._selection_num)]
                    prompt = EoHPrompt.get_prompt_e2(self._task_description_str, indivs, self._template_program)
                    if self._debug_mode:
                ...
                if self._use_m1_operator:
                    ...
                    prompt = EoHPrompt.get_prompt_m1(self._task_description_str, indiv, self._template_program)
                    if self._debug_mode:
                ...
                if self._use_m2_operator:
                    operator = 'm2'
                    indiv = self._population.selection()
                    prompt = EoHPrompt.get_prompt_m2(self._task_description_str, indiv, self._template_program)
                    if self._debug_mode:
